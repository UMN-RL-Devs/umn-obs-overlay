...
export const WebsocketService = {
  ...
  clearEventCallbacks: function (channel, event) {
    if (
      WebsocketService.__subscribers.hasOwnProperty(channel) &&
      WebsocketService.__subscribers[channel].hasOwnProperty(event)
    ) {
  ...
  triggerSubscribers: function (channel, event, data) {
    if (
      ...
      WebsocketService.__subscribers[channel][event].forEach(function (
        callback
      ) {
